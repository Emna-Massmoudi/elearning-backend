...
public class InscriptionController {
    ...
    @PreAuthorize("hasRole('FORMATEUR') or hasRole('ADMIN')")
    public ResponseEntity<List<InscriptionResponse>> getByFormateur(@PathVariable Long formateurId) {
        return ResponseEntity.ok(inscriptionService.getByFormateur(formateurId));
    }
